<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Welcome_ElevatedUser.aspx.cs" Inherits="Class_Management.Welcome_Admin" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div style="margin:auto" class="auto-style1">
                ...
                <Items>
                    <asp:MenuItem Text="Welcome" Value="Welcome" NavigateUrl="~/Welcome_ElevatedUser.aspx"></asp:MenuItem>
                    ...
                    <asp:MenuItem Text="Users" Value="Users" NavigateUrl="~/User_Profile.aspx"></asp:MenuItem>
                        ...
                        <td class="auto-style4">&nbsp;</div><asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Larger" Text="CLASS MANAGEMENT"></asp:Label>
                            ...
                            <br />
                            <br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Welcome Elevated User"></asp:Label>
                            <br />
                            <br />
                            <br />
                            <br />
